    ...
    return StreamBuilder<List<UsersRecord>>(
      stream: queryUsersRecord(
        queryBuilder: (usersRecord) => usersRecord.where(
          'email',
          isEqualTo: 'yosrii.jemaiii@gmail.com',
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<UsersRecord> maptestUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final maptestUsersRecord = maptestUsersRecordList.isNotEmpty
            ? maptestUsersRecordList.first
            : null;
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    if (valueOrDefault(
                                        ...
                                        'admin') {
                                      context.pushNamed(
                                          ReclamationDashboardWidget.routeName);
                                    } else {
                                      context.pushNamed(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed(MapPageWidget.routeName);
                                  },
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'v5sd45ze' /* Choisir votre point de départ */,
                                                                    ),
                                                                    textAlign:
                                                                        TextAlign
                                                                            .center,
