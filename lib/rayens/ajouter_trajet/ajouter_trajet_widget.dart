...
import 'ajouter_trajet_model.dart';
export 'ajouter_trajet_model.dart';

/// page to submit reclamation
class AjouterTrajetWidget extends StatefulWidget {
  const AjouterTrajetWidget({super.key});

  static String routeName = 'AjouterTrajet';
  static String routePath = '/ajouterTrajet';

  @override
  State<AjouterTrajetWidget> createState() => _AjouterTrajetWidgetState();
}

class _AjouterTrajetWidgetState extends State<AjouterTrajetWidget> {
  late AjouterTrajetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjouterTrajetModel());

    _model.pointDepartTextController ??= TextEditingController();
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              context.pushNamed(SuccessTrajetWidget.routeName);
                            },
