...
import 'list_chambres_model.dart';
export 'list_chambres_model.dart';

class ListChambresWidget extends StatefulWidget {
  const ListChambresWidget({
    super.key,
  ...
  static String routeName = 'list_chambres';
  static String routePath = '/listChambres';

  @override
  State<ListChambresWidget> createState() => _ListChambresWidgetState();
}

class _ListChambresWidgetState extends State<ListChambresWidget> {
  late ListChambresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListChambresModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<HebergementRecord>(
      stream: HebergementRecord.getDocument(widget.hebergementRecu!),
      builder: (context, snapshot) {
        ...
        final listChambresHebergementRecord = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<ChambreRecord>(
                      stream: ChambreRecord.getDocument(
                          listChambresHebergementRecord.chambre!),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                        ...
                        final listViewChambreRecord = snapshot.data!;
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 12.0, 4.0, 8.0),
                                                child: Text(
                                                  '${listViewChambreRecord.prix.toString()} TND',
